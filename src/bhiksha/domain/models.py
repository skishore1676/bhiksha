...
class TradeRecord:
    ...
    cohort_contract_sha256: str | None = None
    deployment_contract_sha256: str | None = None
    declared_option_selection_contract_id: str | None = None
    declared_option_selection_contract_sha256: str | None = None
    authorization_identity_status: str | None = None
    exit_policy_id: str | None = None
    exit_policy_sha256: str | None = None
    option_selection_snapshot_id: str | None = None
    option_selection_snapshot_persisted: bool | None = None
    option_candidate_set_sha256: str | None = None
    actual_option_selection_sha256: str | None = None
